...
import { projectsData } from "../static/project";

const statsData = [
  {
    label: "Years Experience",
    value: `${projectsData.stats.yearsExperience}+`,
    color: "text-blue-600",
  },
  {
  ...
  },
  {
    ...
    value: projectsData.stats.clientSatisfaction,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                {/* Contact Info */}
                <div className="flex items-center gap-2 text-xsm sm:text-base text-gray-600 flex-wrap">
